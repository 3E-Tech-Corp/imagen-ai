...
// Increase request body size limit for base64 images (selfies can be large)
...
builder.Services.AddControllers()
    ...
    {
        options.JsonSerializerOptions.DefaultBufferSize = 32 * 1024; // 32KB buffer for large JSON
    });
